...
$( document ).ready(function() {
	...
	var bioBottom = document.getElementById("content_bio").offsetTop + document.getElementById("content_bio").offsetHeight + 30;
	
	var skillsTop = document.getElementById("content_skills").offsetTop + 30;
	var skillsBottom = skillsTop + document.getElementById("content_skills").offsetHeight + 30;
	
	var examplesTop = document.getElementById("content_examples").offsetTop + 30;
	var examplesBottom = examplesTop + document.getElementById("content_examples").offsetHeight + 30;
	
	var experienceTop = document.getElementById("content_experience").offsetTop + 30;
	var experienceBottom = experienceTop + document.getElementById("content_experience").offsetHeight + 30;
	
	var educationTop = document.getElementById("content_education").offsetTop + 30;
